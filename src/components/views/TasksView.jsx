    ...
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Today's Tasks</h1>
                    <p className="text-slate-500 mt-1 font-medium text-sm md:text-base">You have 4 pending tasks for today.</p>
                </div>
                    ...
                    <Card>
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                            <div className="flex items-center gap-6 overflow-x-auto pb-2 sm:pb-0 scrollbar-hide">
                                <button className="text-sm font-bold text-brand-primary border-b-2 border-brand-primary pb-1 shrink-0">To Do</button>
                                <button className="text-sm font-medium text-slate-400 pb-1 shrink-0">Completed</button>
                                <button className="text-sm font-medium text-slate-400 pb-1 shrink-0">Upcoming</button>
                            </div>
                            <button className="p-2 text-slate-400 hover:text-slate-600 self-end sm:self-auto"><Filter size={18} /></button>
                        </div>
                        ...
                        <div className="space-y-3">
                            {tasks.map((task) => (
                                <div
                                    ...
                                    className="flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-xl md:rounded-2xl border border-slate-100 hover:border-brand-primary/20 hover:bg-slate-50/50 transition-all group cursor-pointer"
                                >
                                    <GripVertical size={16} className="text-slate-300 opacity-0 group-hover:opacity-100 cursor-grab hidden sm:block" />
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-3 mt-1">
                                            <span className="text-[9px] md:text-[10px] font-bold uppercase tracking-wider text-slate-400 px-2 py-0.5 rounded-full bg-slate-100">
                                                {task.category}
                                            </span>
                                            {task.priority === 'high' && !task.done && (
                                                <span className="flex items-center gap-1 text-[9px] md:text-[10px] font-bold text-red-500 uppercase">
                                                    <AlertCircle size={10} />
                                                    High
                                                </span>
                                            )}
                ...
                <div className="space-y-6">
                    <Card className="bg-gradient-to-br from-slate-900 to-slate-800 text-white border-none relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-[10px] md:text-xs text-slate-400 font-medium">You're faster than 92% of your peers today.</p>
                    ...
                    <Card>
                        ...
                        <div className="space-y-4">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h5 className="text-[11px] md:text-xs font-bold text-slate-800">Submit expense report</h5>
                                    <p className="text-[9px] md:text-[10px] text-slate-500 font-medium mt-0.5">Tomorrow at 9:00 AM</p>
                                </div>
                            </div>
                        </div>
                    </Card>
